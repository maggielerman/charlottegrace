...
var Countdown = React.createClass({ displayName: "Countdown",
  render: function () {
    return (
      React.createElement("div", { className: "countdown-clock" },
      React.createElement("ul", { id: "countdown" },
      React.createElement("li", { id: "days" },
      React.createElement("div", { className: "number" }, "00"),
      React.createElement("div", { className: "label" }, "Days"),
      React.createElement("svg", { width: "100", height: "100", className: "pie-plate" },
      React.createElement("circle", { r: "50", cx: "50", cy: "50", className: "pie" }))),


      React.createElement("li", { id: "hours" },
      React.createElement("div", { className: "number" }, "00"),
      React.createElement("div", { className: "label" }, "Hours"),
      React.createElement("svg", { width: "100", height: "100", className: "pie-plate" },
      React.createElement("circle", { r: "50", cx: "50", cy: "50", className: "pie" }))),


      React.createElement("li", { id: "minutes" },
      React.createElement("div", { className: "number" }, "00"),
      React.createElement("div", { className: "label" }, "Minutes"),
      React.createElement("svg", { width: "100", height: "100", className: "pie-plate" },
      React.createElement("circle", { r: "50", cx: "50", cy: "50", className: "pie", "stroke-dasharray": "10" }))),


      React.createElement("li", { id: "seconds" },
      React.createElement("div", { className: "number" }, "00"),
      React.createElement("div", { className: "label" }, "Seconds"),
      React.createElement("svg", { width: "100", height: "100", className: "pie-plate" },
      React.createElement("circle", { r: "50", cx: "50", cy: "50", className: "pie" })))),



      React.createElement("p", null, "Remaining 'til Christmas ", React.createElement("span", { className: "this-year" }))));
